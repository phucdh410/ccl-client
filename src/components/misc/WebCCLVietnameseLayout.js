...
export const ContentRow = tw.div`flex-col lg:flex-row justify-between items-center pt-8 lg:pt-12 pb-16 max-w-screen-2xl mx-auto flex-wrap`;
export const Container = tw.div`relative`;
export const ContainerInfo = tw.div`max-w-screen-xl mx-auto py-12 lg:py-16`;
...
//export const PrimaryBackgroundContainer = tw.div`-mx-8 px-8 bg-primary-900 text-gray-100`;
